...
% TODO: Picture of taxonomy. Reasoning for classifying in such a way. Justify
...
sensing/sampling rates of sensor nodes (e.g.~\cite{trihinas2015adam,
jain2004adaptive}), we include algorithms to the Sampling Algorithms category
only if the main focus of the work lies on sampling rate manipulation. % maybe
rewrite that
