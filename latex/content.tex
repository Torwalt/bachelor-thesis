...
devided the mass of algorithms into three sections: \ref{sec:Adaptive Sampling}
Adaptive Sampling, Compressive Sampling and Data Sharing. Many different terms
for the concept of data retrieval from sensors exist in the literature. Data
collection, data sampling, data gathering, and data sensing could be seen as
synonyms, however, we found they are sometimes used in different contexts.
\par
...
\quote{"The process of dynamically adjusting the sampling rate to the current
...
% idea: subsubsections for the subdivisions of the taxonomy categories. One
% layer after the general class
%
