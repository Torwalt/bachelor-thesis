...
\newcommand{\betreuer}{Jonas Traub}%Hier Supervisor2 eintragen
\newcommand{\abgabedatum}{28.02.2019}		%Hier Abgabedatum eintragen (mm/dd/yyyy)
...
\begin{titlepage}
 \begin{center}
  ...
  \vspace{0.7cm}  
  {\begin{onehalfspace}\Huge\textbf \textsf{A Catalogue of Sampling Algorithms
  \linebreak
	for Sensor Data} \end{onehalfspace}}
  \vspace{0.5cm}
%   \berichtuntertitel\\
